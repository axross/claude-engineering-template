...
# required; LINT_FIX_CMD and LINT_FIX_FILE_GLOB are optional — drop both,
# together with the case block that uses them, when the project's FORMAT_CMD
# already subsumes the linter's autofix.
set -uo pipefail
